 ...
 * ========================================
 * File: laporan/export_transaksi_keluar_excel.php
 * Fungsi: Export data transaksi keluar ke format Excel
 */
...
$query = "SELECT sk.*, b.kode_barang, b.nama_barang, b.kategori, b.satuan 
          ...
          WHERE DATE(sk.tanggal) BETWEEN '$tanggal_awal' AND '$tanggal_akhir'
          ORDER BY sk.tanggal DESC, sk.id DESC";

$result = mysqli_query($conn, $query);

// Set header untuk download Excel
$filename = "Laporan_Transaksi_Keluar_" . date('Y-m-d_His') . ".xls";
...
<body>
    ...
    <table style="border: none; width: 100%; margin-bottom: 20px;">
        ...
        <!-- Report Title -->
        <tr>
            <td colspan="9" style="border: 1px solid #000; text-align: center; padding: 12px; background-color: #f8d7da;">
                <strong style="font-size: 14pt;">Laporan Transaksi Stok Keluar</strong>
            </td>
        </tr>
        <!-- Period/Date -->
        <tr>
    ...
    <table>
        ...
        <tfoot>
            <tr class="total-row">
                ...
                <th><?= isset($total_keluar) ? number_format($total_keluar) : 0 ?></th>
                <th colspan="2"></th>
            </tr>
        </tfoot>
    </table>
